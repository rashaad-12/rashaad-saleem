export const profile = {
  ...
  headline: ["I own the problem,", "not the ticket."],
  headlineAccent: 1,
  ...
  certifications: [
    {
      name: "Preparing for Google Cloud Certification: Cloud Engineer",
      issuer: "Google Cloud",
      url: "https://www.coursera.org/account/accomplishments/specialization/BLDEKPVR4CH8",
    },
    {
      name: "Elasticsearch 8 and the Elastic Stack: In-Depth and Hands-On",
      issuer: "Packt",
      url: "https://www.coursera.org/account/accomplishments/specialization/PT3PAODGIPYM",
    },
    {
      name: "Elastic Stack Mastery with Elasticsearch & AWS",
      issuer: "EDUCBA",
      url: "https://www.coursera.org/account/accomplishments/specialization/6JOO5HT9CZOF",
    },
    {
      name: "Kibana Projects: Data Analytics & Visualization",
      issuer: "EDUCBA",
      url: "https://www.coursera.org/account/accomplishments/specialization/K4T3D0PLBTX1",
    },
  ],

  languages: ["Tamil (native)", "English (professional)", "Hindi", "Malayalam"],
};
